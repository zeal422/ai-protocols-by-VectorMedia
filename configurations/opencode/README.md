...
### Option 1: .opencoderules File (Recommended)
...
### Option 2: opencode.json configuration

Copy `opencode.json` to your project root or global config directory (`~/.config/opencode/opencode.json`).
