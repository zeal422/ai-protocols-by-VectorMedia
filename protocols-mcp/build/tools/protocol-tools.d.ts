...
export declare function registerProtocolTools(server: Server, scanner: ProtocolScanner, indexer: ContentIndexer, matcher: SearchMatcher, protocolsRoot: string): void;
